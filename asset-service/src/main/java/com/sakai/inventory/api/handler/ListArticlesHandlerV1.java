 ...
 */
public class ListArticlesHandlerV1 implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    private static final Logger LOGGER = LoggerFactory.getLogger(ListArticlesHandlerV1.class);

    public ListArticlesHandlerV1() {
